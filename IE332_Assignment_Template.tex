...
\addcontentsline{toc}{section}{Adversarial Attacks}
\section*{Adversarial Attacks}
Unfortunately, since we were unable to get adversarial attacks working, we were also not able to evaluate their performance. We would assume these attacks would work well in fooling the classifier because of the extensive information and feedback on them from others.
\addcontentsline{toc}{section}{Alternate Approaches}
\section*{Alternate Approaches}
\noindent{\bf Alternate Algorithm 1 - Grayscale}\\
